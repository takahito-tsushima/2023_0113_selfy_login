...
<form method="POST" action="insert02_torisetsu.php" name="torisetsu">
...
<fieldset>
    <ul>
        ...
        <p>7.誰かが仕事で困ったら？</p>
            <div>
                <input required type="radio" name="forMyColleague07" id="forMyColleague07_01" value="なるべく助けたい！"><labe for="forMyColleague07_01">なるべく助けたい！</labe>
...
<fieldset>
    ...
    <a id="submit" onclick="document.torisetsu.submit()">送信</a>
