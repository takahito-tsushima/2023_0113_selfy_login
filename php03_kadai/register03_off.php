...
<form method="POST" action="insert03_off.php" name="profileOFF">
        ...
        <fieldset>
            <ul>
                ...
                <p>（各200文字以内）</p>
                    ...
                    <li><P>休日の過ごし方</P></li>
                    <li id="js_holiday"><input type="text" maxlength=200 id="js_holiday" name="holiday"></li>
                    <li><P>興味関心のあること   </P></li>
                    <li id="js_interest"><input type="text" maxlength=200 id="js_interest" name="interest"></li>
                    <li><P>ハマっているもの</P></li>
                    <li id="js_crazy"><input type="text" maxlength=200 id="js_crazy" name="crazy"></li>
                    <li><P>最近好きになったもの</P></li>
                    <li id="js_love"><input type="text" maxlength=200 id="js_love" name="love"></li>
                    <li><P>大切にしているもの</P></li>
                    <li id="js_important"><input type="text" maxlength=200 id="js_important" name="important"></li>
                    <li><P>自慢のコレクション</P></li>
                    <li id="js_collection"><input type="text" maxlength=200 id="js_collection" name="collection"></li>
                    <li><P>一番高価な買い物</P></li>
                    <li id="js_expensive"><input type="text" maxlength=200 id="js_expensive" name="expensive"></li>
                    <li><P>尊敬する人や憧れの人</P></li>
                    <li id="js_respect"><input type="text" maxlength=200 id="js_respect" name="respect"></li>


                <a id="back_to_profileOff_01">戻る</a>
                <a id="submit" onclick="document.profileOFF.submit()">送信</a>
